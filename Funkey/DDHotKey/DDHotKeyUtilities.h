...
extern NSString *DDStringFromKeyCodeOnly(unsigned short keyCode);
extern NSString *DDStringFromModifier(NSUInteger modifiers);
...
extern NSUInteger DDCarbonCocoaModifiersFromModifierFlags(UInt32 flags);
